...
export const GAMES = [
  {
    ...
    skin: "bronze", action: "Start the run", tag: "RUN / PC", signal: "↯",
  ...
  },
  {
    ...
    skin: "flower", action: "Open the book", tag: "BLOOM / MOBILE", signal: "✿",
  ...
  },
  {
    ...
    skin: "boxjam", action: "Sort the boxes", tag: "SORT / PUZZLE", signal: "↳",
  ...
  },
  {
    ...
    skin: "word", action: "Bend a word", tag: "BEND / WORDPLAY", signal: "⌁",
  ...
  },
  {
    ...
    skin: "card", action: "Deal the cards", tag: "DEAL / SOLITAIRE", signal: "♥",
  ...
  },
  {
    ...
    skin: "sapper", action: "Clear the field", tag: "CLEAR / PUZZLE", signal: "✕",
  ...
  },
  {
    ...
    skin: "lords", action: "Enter the cloud", tag: "ORBIT / SPACE", signal: "◌", logoTop: "Astro", logoMain: "Lords", subtitle: "Oort Cloud",
